...
const bcryptFunctions = require("./service/password-encryption-service");
...
async function userCreate(firstName, lastName, username, email, password, reputation, registration_date_time) {
    let userdetail = {}
    ...
    if (password != false) userdetail.password = hash;
